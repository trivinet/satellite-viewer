...
const dataUsage = [
  ...
  { name: "Communicaciones", value: 2867 },
  { name: 'Desconocido/Secreto', value: 1425},
  { name: "Observación terrestre", value: 1006 },
  { name: "Desarrollo tecnológico", value: 355 },
  { name: "Navegación", value: 164 },
  { name: "Desarrollo Espacial", value: 104 },
  { name: "Investigación", value: 35 },
  { name: "Ciencia", value: 20 },
  { name: "Observación espacial", value: 10 },
];

const dataUsage3 = [
  { name: "Comercial", value: 4237 },
  { name: "Militar", value: 585 },
  { name: "Gubernamental", value: 217 },
  { name: "Civil", value: 210 }
];

const dataOrbit = [
  { name: "LEO", value: 4700, description: 'Low-Eart-Orbit: órbitas con un periodo igual o menor a 128 minutos (11.25 revoluciones diarias) y una excentricidad menor a 0.25. Región: altitudes menores a 2,000km' },
  { name: "GEO", value: 565, description: 'Geostacionary Orbit: órbitas cuyo período es el período de rotación de la tierra (t = 23h 56min 4s, o Movimiento medio [0,99,1.01]). Región: altitud de 35,786km' },
  { name: "MEO", value: 140, description: 'Medium-Eart-Orbit: órbitas con un periodo comprendido entre 600 y 800 minutos y una excentricidad menor a 0.25. Región: altitudes entre 2,000 y 35,786km' },
  { name: "HEO", value: 60, description: 'High-Elliptical-Orbit: órbitas cuya excentricidad es mayor de 0.25.' }
];
const dataOrbitLEO = [
  { name: "Inclinada no-polar", value: 2580 , description: 'Inclinación de hasta 75º o mayores a 105º, para el caso de órbita retrógrada'},
  { name: "Heliosíncrona", value: 1410, description: 'Órbita polar cuyos puntos de paso por los polos coinciden siempre con la misma posición relativa del sol, o, de igual forma, que pasan por la misma ubicación a la misma hora local.' },
  { name: "Polar", value: 673 , description: 'Inclinación igual o mayor a 75º' },
  { name: "Ecuatorial", value: 18 , description: 'Inclinación entre 20º y -20º'},
  { name: "No definida", value: 11, description: '' },
  { name: "Elíptica", value: 8 , description: 'Excentricidad mayor de 0.05 y hasta 0.25'}];

const dataOrbitGEO=[{ name: "GEO", value: 565, description:  'Geostacionary Orbit: órbitas cuyo período es el período de rotación de la tierra (t = 23h 56min 4s, o Movimiento medio [0,99,1.01]). Región: altitud de 35,786km' }];

const dataOrbitMEO=[{ name: "Inclinada no-polar", value: 95 , description: 'Inclinación de hasta 75º o mayores a 105º, para el caso de órbita retrógrada' },
{ name: "No definida", value: 25, description: '' },
{ name: "Ecuatorial", value: 20, description: 'Inclinación entre 20º y -20º' },];
  
const dataOrbitHEO=[{ name: "Molniya", value: 23 , description: 'Alta excentricidad (perigeo con altitudes en torno a 500km y apogeo con altitudes en torno a 38900) e inclinación (~60º)'},
{ name: "No definida", value: 21 },
{ name: "Alta excentricidad profunda", value: 9, descrption: 'Excentricidad > 0.7' },
{ name: "Heliosíncrona", value: 4, description: 'Inclinación de hasta 75º o mayores a 105º, para el caso de órbita retrógrada' },
{ name: "Inclinada no-polar", value: 2, description: 'Inclinación de hasta 75º o mayores a 105º, para el caso de órbita retrógrada. IBEX, VELA.' },
{ name: "High Earth Orbit", value: 1 , description: 'TESS' }];


const dataFamilies=[{ name: "Resto de satélites", value: 2845 },
{  name: "Space-X", value: 2219 },
{ name: "OneWeb", value: 427 },
{ name: "Plante Labs, Inc.", value: 215 },
{ name: "Swarm Technologies", value: 151 },
{ name: "Chinese Ministry of National Defense", value: 135 },
{ name: "Spire Global Inc.", value: 124 },
{ name: "Ministry of Defense US", value: 111 },
{ name: "Iridium Communications, Inc.", value: 75 }];

const dataPaises=[{ name: "EEUU", value: 3415, description: '' },
{ name: "China", value: 535, description: '' },
{ name: "Reino Unido", value: 486, description: '' },
{ name: "Rusia", value: 170 , description: '' },
{ name: "Japón", value: 88 , description: '' },
{ name: "ESA", value: 62 , description: '' },
{ name: "Internacional", value: 60 , description: ''},
